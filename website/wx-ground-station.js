...
AWS.config.credentials = new AWS.CognitoIdentityCredentials({
    IdentityPoolId: 'us-west-2:0f050b41-ebcc-4325-920c-96ef9bc8ee69',
});

// Create a mapbox.com account and get access token
const MAP_BOX_ACCESS_TOKEN = 'pk.eyJ1IjoiY3lzdGVubmluIiwiYSI6ImNrN2kyYmlmbTA4dXEzaWxuOGwzZXcxZTgifQ.0I8F1C1diuctSdFVRB-siQ';
const GROUND_STATION_LAT =  47.2667;
const GROUND_STATION_LON = -122.5630;
const GROUND_STATION_NAME = 'KJ7ATK - Gig Harbor, WA';
